export function SiteFooter() {
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-night">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-3 px-4 py-8 text-sm text-slate-200 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <p>Internship portfolio for John Raymond Gallego at Makerspace InnovHub.</p>
