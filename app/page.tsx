          ...
          <div className="min-w-0 space-y-7 motion-safe:animate-fade-up">
            ...
            <div className="space-y-5">
              ...
              <h1 className={`${heroFont.className} max-w-3xl text-2xl font-bold leading-tight tracking-[0.035em] text-orange-300 sm:text-4xl lg:text-5xl`}>
                <span className="block text-lg font-bold tracking-[0.08em] text-orange-100 sm:text-2xl">
                  Hi, I&apos;m John.
                </span>
                <span className="mt-3 block">
                  Johnraymond Gallego designs practical systems with a polished digital edge.
                </span>
              </h1>
            ...
            <div className="marquee-mask w-full max-w-full overflow-hidden border-y border-white/10 py-3">
              <div className="flex w-max animate-ticker gap-3 hover:[animation-play-state:paused]">
                {[...movingTech, ...movingTech].map((tech, index) => (
                  <span
                    className="rounded-full border border-white/10 bg-white/[0.08] px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-orange-100"
                    key={`${tech}-${index}`}
                  >
                    {tech}
                  </span>
